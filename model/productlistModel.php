...
Class productlistModel Extends baseModel {
    ...
    public function deleteProduct($id){
    	if ($this->getProduct($id)) {
    		return $this->delete($this->table,array('product_list_id'=>$id));
    	}
    }
    ...
    public function getAllProductByWhere($id){
        return $this->query('SELECT * FROM product_list WHERE product_list_id != '.$id);
    }
    public function getLastProduct(){
        return $this->getLast($this->table);
    }
    public function checkProduct($id,$seri){
        return $this->query('SELECT * FROM product_list WHERE product_list_id != '.$id.' AND product_code = "'.$seri.'"');
    }
